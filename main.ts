...
let apiLink : any = "https://v6.exchangerate-api.com/v6/1b3255cd918fdaf8db1f5136/latest/PKR";
...
//Conversion Rate:
let cnvRate: any = `https://v6.exchangerate-api.com/v6/1b3255cd918fdaf8db1f5136/pair/${firstCuntry.name}/${secondCuntry.name}`;

//fetching Data for Conversion Rate:
let cnvRateData = async (data:any) => {
